...
/** @constructor */
function $c_Lplayscala_ScalaJSExample$() {
  $c_O.call(this)
}
$c_Lplayscala_ScalaJSExample$.prototype = new $h_O();
$c_Lplayscala_ScalaJSExample$.prototype.constructor = $c_Lplayscala_ScalaJSExample$;
/** @constructor */
function $h_Lplayscala_ScalaJSExample$() {
  /*<skip>*/
}
$h_Lplayscala_ScalaJSExample$.prototype = $c_Lplayscala_ScalaJSExample$.prototype;
$c_Lplayscala_ScalaJSExample$.prototype.init___ = (function() {
  return this
});
$c_Lplayscala_ScalaJSExample$.prototype.main__AT__V = (function(args) {
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("scalajsShoutOut").textContent = "It works!";
  var this$2 = $m_s_Console$();
  var this$3 = $as_Ljava_io_PrintStream(this$2.outVar$2.v$1);
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Call the react stuff.\n");
  var jsx$3 = $g.ReactDOM;
  ...
  if ((inst[0] === null)) {
    throw new $c_jl_IllegalStateException().init___T("This tag has already been built into a ReactElement, and cannot be reused")
  };
  var ret = $g.React.createElement.apply($g.React, inst);
  inst[0] = null;
  jsx$3.render(ret, $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().getElementById("root"))
});
var $d_Lplayscala_ScalaJSExample$ = new $TypeData().initClass({
  Lplayscala_ScalaJSExample$: 0
}, false, "playscala.ScalaJSExample$", {
  Lplayscala_ScalaJSExample$: 1,
  O: 1
});
$c_Lplayscala_ScalaJSExample$.prototype.$classData = $d_Lplayscala_ScalaJSExample$;
var $n_Lplayscala_ScalaJSExample$ = (void 0);
function $m_Lplayscala_ScalaJSExample$() {
  if ((!$n_Lplayscala_ScalaJSExample$)) {
    $n_Lplayscala_ScalaJSExample$ = new $c_Lplayscala_ScalaJSExample$().init___()
  };
  return $n_Lplayscala_ScalaJSExample$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$m_Lplayscala_ScalaJSExample$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
